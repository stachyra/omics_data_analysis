...
count data in each cell is normalized so that individual cells have
approximately equal effective weight, in terms of the total number of
...
![](scRNA_TCGA_brain_gliomas_Seurat_files/figure-gfm/unnamed-chunk-10-2.png)<!-- -->
